...
subheader = st.subheader("This site is POC user interface of CDP. When you sumbit your (fake) email on https://jiriklimecky.tech/, you can check here that the email is stored together with GA4 Client ID")
