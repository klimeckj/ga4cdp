...
#sub_text = st.text("1) Submit your (fake) email on this site", href="https://jiriklimecky.tech/")
sub_text = st.markdown("1) Submit your (fake) email on [Jiří Klimecký](https://jiriklimecky.tech/)")
